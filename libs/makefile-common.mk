...
C_FLAGS_ASM_RELEASE = $(C_FLAG_ASSEMBLY) $(PROJECT_FLAGS)
C_FLAGS_ASM_DEBUG = $(C_FLAG_ASSEMBLY) $(C_FLAGS_DEBUG) $(PROJECT_FLAGS)

# flags only for object targets #
C_FLAGS_OBJS_RELEASE = $(C_FLAG_NO_LINKING) $(C_FLAG_O_REC) $(PROJECT_FLAGS)
C_FLAGS_OBJS_DEBUG = $(C_FLAG_NO_LINKING) $(C_FLAG_O_DEBUG) $(C_FLAGS_DEBUG) $(PROJECT_FLAGS)

# flags only for executable target #
C_FLAGS_EXEC_RELEASE = $(C_FLAG_PIE_NO) $(C_FLAG_RT_BOF_DET) $(PROJECT_FLAGS)
C_FLAGS_EXEC_DEBUG = $(C_FLAG_PIE_NO)  $(C_FLAGS_DEBUG) $(PROJECT_FLAGS)
